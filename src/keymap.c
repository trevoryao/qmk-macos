...
enum ctrl_keycodes {
    ...
    G_OS                // Flashes once for macOS, twice for windows
};
...
enum layer_names {
    ...
    _FUNC1,  // Function Layout: The function key activated layout and FN Keys
...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [_MAC] = LAYOUT(
        KC_ESC,  KC_F14,  KC_F15,  RCTL(KC_UP),   SCMD(KC_5),   RCTL(KC_LEFT),   RCTL(KC_RIGHT),   KC_MPRV,   KC_MPLY,   KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,             DF(_WIN),   L_T_ONF, KC_POWER, \
        KC_GRV,  KC_1,    KC_2,    KC_3,          KC_4,         KC_5,            KC_6,             KC_7,      KC_8,      KC_9,      KC_0,     KC_MINS,  KC_EQL,  KC_BSPC,    KC_INS,  KC_HOME, KC_PGUP, \
        KC_TAB,  KC_Q,    KC_W,    KC_E,          KC_R,         KC_T,            KC_Y,             KC_U,      KC_I,      KC_O,      KC_P,     KC_LBRC,  KC_RBRC, KC_BSLS,    KC_DEL,  KC_END,  KC_PGDN, \
        KC_CAPS, KC_A,    KC_S,    KC_D,          KC_F,         KC_G,            KC_H,             KC_J,      KC_K,      KC_L,      KC_SCLN,  KC_QUOT,  KC_ENT, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,          KC_V,         KC_B,            KC_N,             KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,  KC_RSFT,                                KC_UP, \
        KC_LCTL, KC_LOPT, KC_LCMD,                              KC_SPC,                                                  KC_RCMD,   KC_ROPT,  MO(_FUNC1),    KC_RCTL,             KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [_FUNC1] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,              _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
        L_T_BR,  L_PSD,   L_BRI,   L_PSI,   _______, _______, _______, _______, U_T_AGCR,_______, _______, _______, _______, _______,   _______, _______, _______, \
    ...
    [_WIN] = LAYOUT(
        KC_ESC,  KC_BRID, KC_BRIU, KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_MPRV,   KC_MPLY,   KC_MNXT,   KC_MUTE,  KC_VOLD,  KC_VOLU,             DF(_MAC),   L_T_ONF, KC_POWER, \
        KC_GRV,  KC_1,    KC_2,    KC_3,    KC_4,    KC_5,    KC_6,    KC_7,      KC_8,      KC_9,      KC_0,     KC_MINS,  KC_EQL,  KC_BSPC,    KC_INS,  KC_HOME, KC_PGUP, \
        KC_TAB,  KC_Q,    KC_W,    KC_E,    KC_R,    KC_T,    KC_Y,    KC_U,      KC_I,      KC_O,      KC_P,     KC_LBRC,  KC_RBRC, KC_BSLS,    KC_DEL,  KC_END,  KC_PGDN, \
        KC_CAPS, KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,      KC_K,      KC_L,      KC_SCLN,  KC_QUOT,  KC_ENT, \
        KC_LSFT, KC_Z,    KC_X,    KC_C,    KC_V,    KC_B,    KC_N,    KC_M,      KC_COMM,   KC_DOT,    KC_SLSH,  KC_RSFT,                                KC_UP, \
        KC_LWIN, KC_LALT, KC_LCTL,                   KC_SPC,                                 KC_RCTL,   KC_RALT,  MO(_FUNC2),    KC_RWIN,             KC_LEFT, KC_DOWN, KC_RGHT \
    ),
    [_FUNC2] = LAYOUT(
        _______, KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12,              _______, _______, _______, \
        _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______, _______,   _______, _______, _______, \
...
led_instruction_t led_instructions[] = {
    ...
    { .flags = LED_FLAG_MATCH_ID | LED_FLAG_USE_RGB, .id0 = 0xFFFFFFFF, .id1 = 0xFFFFFFFF, .id2 = 0xFFFFFFFF, .id3 = 0x7FFFFF, .r = 0x81, .g = 0xD8, .b = 0xD0 },
